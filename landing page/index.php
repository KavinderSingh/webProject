...
<body>
    ...
    <div class="jumbotron jumbotron-fluid">
      <div class="container">
        ...
        <a class="badge badge-pill badge-primary" style="background: linear-gradient(-45deg, #067aa5, #0ff3be );" href="../electronics/electronics.html">
      ...
      <div class="jumbotron jumbotron-fluid">
        <div class="container">
          ...
          <a class="badge badge-pill badge-primary col-sm-3 mb-2" style="background: linear-gradient(-45deg, #067aa5, #0ff3be );" href="../clothing/clothing.html">
            <h3 style="padding: 2px;">View All Clothes</h3>
          </a>
          <a class="badge badge-pill badge-primary col-sm-3" style=" margin-left: 5px;background: linear-gradient(-45deg, #067aa5, #0ff3be );" href="#">
